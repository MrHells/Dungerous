 ...
 * @author Xoppa */
public class ColisionExample implements ApplicationListener {
    ...
    public void create () {
        ...
        constructors.put("ground", new GameObject.Constructor(model, "ground", new btBoxShape(new Vector3(10f, 0.5f, 10f)), 0f));
